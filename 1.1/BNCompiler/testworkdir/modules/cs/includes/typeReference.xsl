...
>
    ...
    <xsl:template name="typeReference">
        <xsl:choose>
            ...
            <xsl:when test="typeReference/isSequenceOf = 'true'">System.Collections.Generic.ICollection&lt;<xsl:for-each select="typeReference"><xsl:call-template name="elementType"/></xsl:for-each>&gt; </xsl:when>
