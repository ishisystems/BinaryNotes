...
public ASNLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("ACCESS", this), new Integer(152));
	...
	literals.put(new ANTLRHashString("DEFVAL", this), new Integer(157));
	...
	literals.put(new ANTLRHashString("SYNTAX", this), new Integer(151));
	...
	literals.put(new ANTLRHashString("INDEX", this), new Integer(156));
	...
	literals.put(new ANTLRHashString("REFERENCE", this), new Integer(155));
	...
	literals.put(new ANTLRHashString("STATUS", this), new Integer(153));
	...
	literals.put(new ANTLRHashString("DESCRIPTION", this), new Integer(154));
