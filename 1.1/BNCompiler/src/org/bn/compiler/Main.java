...
public class Main {
    private final static String version = "1.1.0b";
    ...
    private void createModel(ByteArrayOutputStream outputXml, String[] args,
                             Module module)
    ...
    public static void main(String args[]) {
        try {
            ...
            System.out.println("        (c) 2006 Abdulla G. Abdurakhmanov");
            new Main().start(args);
        } catch (Exception ex) {
