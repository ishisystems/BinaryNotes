...
{	
	...
	{		
		...
		protected virtual DecodedObject<object> decodeSequence(DecodedObject<object> decodedTag, System.Type objectClass, ElementInfo elementInfo, System.IO.Stream stream)
		{
			...
			for (int i = 0; i < fields.Length; i++)
			{
				...
				DecodedObject<object> obj = decodeSequenceField(
                    fieldTag, sequence, field, stream, elementInfo
                );
				if (obj != null)
				{
		...
		protected virtual DecodedObject<object> decodeSequenceField(DecodedObject<object> fieldTag, object sequenceObj, PropertyInfo field, System.IO.Stream stream, ElementInfo elementInfo)
		{
