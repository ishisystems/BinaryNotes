...
public class BEREncoder<T> extends Encoder<T> {
    ...
    protected int encodeReal(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
        ...
        resultSize += encodeLength(szOfInt, stream);
        resultSize += encodeTag( 
            BERCoderUtils.getTagValueForElement(elementInfo,TagClass.Universal, ElementType.Primitive, UniversalTag.Real),
            stream
        );
        return resultSize;
    }
    ...
    protected int encodeBitString(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
        ...
        resultSize += encodeLength(sizeOfString, stream);
        resultSize += encodeTag( 
            BERCoderUtils.getTagValueForElement(elementInfo,TagClass.Universal, ElementType.Primitive, UniversalTag.Bitstring),
            stream
        );
        return resultSize;
    }
    ...
    protected int encodeString(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
        ...
        resultSize += encodeLength(sizeOfString, stream);
        resultSize += encodeTag( 
            BERCoderUtils.getTagValueForElement(elementInfo,TagClass.Universal, ElementType.Primitive, CoderUtils.getStringTagForElement(elementInfo)),
            stream
        );
        return resultSize;
    }
    ...
    protected int encodeSequenceOf(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {    
        ...
        if(!seqInfo.isSetOf()) {
            ...
            resultSize += encodeTag( 
                BERCoderUtils.getTagValueForElement(elementInfo,TagClass.Universal, ElementType.Constructed, UniversalTag.Set),
                stream
            );            
        }
        return resultSize;
